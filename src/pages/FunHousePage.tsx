        ...
        <div className={containerClass}>
          ...
          {showFakeModal && stage !== "blackout" && (
            <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
              <div className="w-full max-w-sm rounded-2xl border border-zk-border bg-zk-elevated p-6 text-center font-zk-sans shadow-[0_24px_64px_-24px_rgba(0,0,0,0.65)]">
                <h3 className="mb-2 text-xl font-semibold tracking-[-0.02em] text-zk-text">
                  500 Internal Server Error
                </h3>
                <button
                  className="mt-4 rounded-xl bg-zk-indigo px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-zk-indigo-hover"
