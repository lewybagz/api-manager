...
import { Pencil, Save, Tag, Trash } from "lucide-react";
...
export default function TagsPage() {
  ...
  return (
    <div className="grid gap-4">
      ...
      {editingId ? (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm font-zk-sans"
          onClick={() => setEditingId(null)}
          role="presentation"
        >
          <div
            className="w-full max-w-md rounded-2xl border border-zk-border bg-zk-elevated shadow-[0_24px_64px_-24px_rgba(0,0,0,0.65)]"
            ...
            <div className="p-6">
              ...
              <div className="grid gap-5">
                <div>
                  ...
                  <input
                    className="w-full rounded-xl border border-zk-border bg-zk-base/80 px-4 py-3 text-sm text-zk-text transition-colors placeholder:text-zk-muted/50 focus:border-zk-indigo/40 focus:outline-none focus:ring-2 focus:ring-zk-indigo/30"
                    id="edit-tag-name"
                    value={editingName}
                ...
                <div>
                  <span className="mb-2 block text-sm font-medium text-zk-muted">
                    Color
                  </span>
                  <ColorPopover
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <button
                    className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-zk-indigo py-3 text-sm font-medium text-white transition-colors hover:bg-zk-indigo-hover"
                    onClick={async () => {
                      const id = editingId;
