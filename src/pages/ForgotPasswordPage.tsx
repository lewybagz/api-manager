          ...
          {submitted ? (
            <div className="flex flex-col items-center text-center w-full">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Link
                  className="inline-flex items-center justify-center rounded-xl bg-zk-indigo px-6 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-zk-indigo-hover"
                  to="/login"
                >
                  Credential manager
                </Link>
                <Link
                  className="inline-flex items-center justify-center rounded-xl border border-zk-border bg-zk-base/60 px-6 py-3 text-center text-sm font-medium text-zk-text transition-colors hover:border-zk-indigo/35 hover:bg-zk-indigo/10"
                  to="/pw/login"
                >
                  Passwords app
                </Link>
            ...
            >
              ...
              <div className="flex flex-col gap-2 text-center text-sm sm:flex-row sm:justify-center sm:gap-4">
                <Link
                  className="font-medium text-zk-indigo transition-colors hover:text-zk-indigo-hover"
                  to="/login"
                >
                  ← Credential manager
                </Link>
