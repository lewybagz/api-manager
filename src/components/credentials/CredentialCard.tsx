...
const CredentialCard: React.FC<CredentialCardProps> = ({
  ...
  return (
    <div className="relative bg-brand-dark-secondary/60 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-brand-blue/20 hover:border-brand-blue/40 w-full group">
      <div className="flex flex-col md:flex-row items-start md:items-center p-2 gap-4">
        ...
        <div className="flex-1 flex items-center gap-3 min-w-0 pr-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              <h3 className="text-md font-bold text-brand-light truncate transition-colors duration-200 group-hover/btn:text-brand-blue">
          ...
          {credential.notes && (
            <div className="relative flex items-center group/notes">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-xs p-3 bg-gray-900 border border-gray-700 rounded-lg text-xs text-gray-300 whitespace-pre-wrap break-words shadow-2xl opacity-0 group-hover/notes:opacity-100 transition-opacity duration-300 pointer-events-none z-10">
                {credential.notes}
              </div>
            </div>
          )}
        ...
        <div
          className={cn(
            "flex flex-col md:flex-row items-stretch md:items-center gap-2 font-mono text-xs w-full md:w-auto",
        ...
        <div className="flex items-center gap-1.5 self-start md:self-center">
          {credential.apiKey === "PLACEHOLDER-RESET-VALUE" && onUpdateNeeded ? (
            <button
